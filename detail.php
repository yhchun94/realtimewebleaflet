...
<body style="background-color: #fff;">
  ...
  <section data-role="page" id="swipeflick" class="eventPage" data-next="" data-prev="index" data-dom-cache="true" style="background-color: #fff;">
    ...
    <div class="container pt-4" style="background-color: #fff;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_1-1">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">1-1. 깨진 창문들의 도시 - 깨진 창문들</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing1">01:40</span> / <span>6:40</span>
              </div>
            </div>
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_2">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">2. 미션완료 : 벨린시지</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing3">00:00</span> / <span>47:23</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_3">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">3. 소셜심</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing4">00:00</span> / <span>18:19</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_4">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">4. 태양의 공장</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing5">00:00</span> / <span>23:00</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_5">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">5. 야성적 충동</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing6">00:00</span> / <span>24:00</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_6">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-3" style="flex: 1;">6. 이것이 미래다</div>
              <div class="mt-3 text-right" style="flex: 1;">
                <span id="timing7">00:00</span> / <span>16:00</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
        ...
        <div style="height: 100px; cursor: pointer;" data-toggle="modal" data-target="#modal_7">
          ...
          <div style="float:left; margin: 10px 0px 0px 0px; width: 75%;" class="pl-4">
            <div style="display: flex;">
              <div class="mt-1" style="flex: 2 1;">7. 안 보여주기: 빌어먹게 유익하고 교육적인.MOV파일</div>
              <div class="mt-1 text-right" style="flex: 1;">
                <span id="timing8">00:00</span> / <span>10:00</span>
              </div>
            </div>
            <div style="display: flex; background-color: rgb(195, 195, 195); height: 10px;">
  ...
  <!-- Modal -->
  <div class="modal modal-center fade" id="modal_1-1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;깨진 창문들&gt;&nbsp;2022</b></span><br /><br />
          이 작품은 전시공간의 양극에 위치한 두 개의 영상 설치작품 &lt;깨진 창문들&gt;과 &lt;깨지지 않은 창문들&gt;및 창문을 형상화한 평면 패널, 그리고 벽에 부착된 문구들로 구성되어 있다.  &lt;깨진 창문들&gt;은 어떻게 인공지능과 컴퓨터 알고리즘이  새로운 보안 기술을 발전시키는데 사용될 수 있는지를 보여준다. 제2차 세계대전 당시 지어진 런던의 비행기  격납고에서 오디오 분석 기술자들이 창문 깨는 소리를 녹음 하여 소리의 수많은 견본을 만들고, 컴퓨터가 이 소리의  코드를 모델링하여 학습하게 한다. 그들의 목적은 침입의 소리, 즉 유리창 깨는 소리를 식별하기 위한 시스템을 컴퓨터 인공지능에 기록하고 이를 홈 보안 시스템에 적용하는 것이었다.
          <br/> 
          &lt;깨진 창문들&gt;과 대구를 이루는 &lt;깨지지 않은 창문들&gt;은 나무 패널에 창문 모양을 그려 넣어 깨진 창문을 가림으로써 범죄의 가능성을 최소화하려는, 미국 뉴저지 캠던 비영리 기관의 멤버들을 인터뷰한 영상이다. 깨진 창문 하나로 다른 창문들까지 깨질 수 있고 여러 형탱의 사회 혼란을 야기할 수  있다는, '깨진 창문 이론'은 이 영상의 수행적 지지대이다.  두 비디오 사이에 위치한 긴 벽에는 영상 속에 크리스 토퍼가 그린 것과 같은 창문을 형상화한 평면 패널들이 위치한다. 또한 19세기 깨진 창문을 경제적 기회의 비유로 사용하면서 유명해진 프랑스 경제학자인 프레데릭 바스티아의 글이 전시장 벽에 인용된다.
        </div>
      </div>
    </div>
  </div>

  <div class="modal modal-center fade" id="modal_1-2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;깨지지 않은 창문들&gt;&nbsp;2022</b></span><br /><br />
          이 작품은 전시공간의 양극에 위치한 두 개의 영상 설치작품 &lt;깨진 창문들&gt;과 &lt;깨지지 않은 창문들&gt;및 창문을 형상화한 평면 패널, 그리고 벽에 부착된 문구들로 구성되어 있다.  &lt;깨진 창문들&gt;은 어떻게 인공지능과 컴퓨터 알고리즘이  새로운 보안 기술을 발전시키는데 사용될 수 있는지를 보여준다. 제2차 세계대전 당시 지어진 런던의 비행기  격납고에서 오디오 분석 기술자들이 창문 깨는 소리를 녹음 하여 소리의 수많은 견본을 만들고, 컴퓨터가 이 소리의  코드를 모델링하여 학습하게 한다. 그들의 목적은 침입의 소리, 즉 유리창 깨는 소리를 식별하기 위한 시스템을 컴퓨터 인공지능에 기록하고 이를 홈 보안 시스템에 적용하는 것이었다.
          <br/> 
          &lt;깨진 창문들&gt;과 대구를 이루는 &lt;깨지지 않은 창문들&gt;은 나무 패널에 창문 모양을 그려 넣어 깨진 창문을 가림으로써 범죄의 가능성을 최소화하려는, 미국 뉴저지 캠던 비영리 기관의 멤버들을 인터뷰한 영상이다. 깨진 창문 하나로 다른 창문들까지 깨질 수 있고 여러 형탱의 사회 혼란을 야기할 수  있다는, '깨진 창문 이론'은 이 영상의 수행적 지지대이다.  두 비디오 사이에 위치한 긴 벽에는 영상 속에 크리스 토퍼가 그린 것과 같은 창문을 형상화한 평면 패널들이 위치한다. 또한 19세기 깨진 창문을 경제적 기회의 비유로 사용하면서 유명해진 프랑스 경제학자인 프레데릭 바스티아의 글이 전시장 벽에 인용된다.
        </div>
  ...
  <div class="modal modal-center fade" id="modal_2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;미션 완료: 벨란시지&gt;&nbsp;2019</b></span><br /><br />
  ...
  <div class="modal modal-center fade" id="modal_3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;소셜심&gt;&nbsp;2020</b></span><br /><br />
  ...
  <div class="modal modal-center fade" id="modal_4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;태양의 공장&gt;&nbsp;2015</b></span><br /><br />
  ...
  <div class="modal modal-center fade" id="modal_5" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;야성적 충동&gt;&nbsp;2022</b></span><br /><br />
  ...
  <div class="modal modal-center fade" id="modal_6" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;이것이 미래다&gt;&nbsp;2019</b></span><br /><br />
  ...
  <div class="modal modal-center fade" id="modal_7" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-center" style="width: 350px; margin: 30px 0px;">
      <div class="modal-content" style="border-radius: 20px;">
        <div class="modal-body">
          <span style="font-size: 18px;"><b>&lt;안 보여주기 : 빌어먹게 유익하고 교육적인 .MOV 파일&gt;&nbsp;2013</b></span><br /><br />
  ...
  <script>
    ...
    function countUp1() {
        cnt1++;
        if (cnt1 > 400) { clearInterval(up1); } // 6:40 을 초로 변환 시 400
        if (cnt1 == 400+1) { cnt1 = 0; setInterval(countUp1, 1000); } // 400+1 = 401초가 되었을 때 초기화
        time1(cnt1);
    }
    ...
    function countUp2() {
        cnt2++;
        if (cnt2 > 600) { clearInterval(up2); } // 10:00 을 초로 변환 시 600
        if (cnt2 == 600+1) { cnt2 = 0; setInterval(countUp2, 1000); } // 600+1 = 601초가 되었을 때 초기화
        time2(cnt2);
    }
    ...
    // 2
    countUp3();
    up3 = setInterval(countUp3, 1000);
    function countUp3() {
        cnt3++;
        if (cnt3 > 2843) { clearInterval(up3); } // 47:23 을 초로 변환 시 2843
        if (cnt3 == 2843+1) { cnt3 = 0; setInterval(countUp3, 1000); } // 2843+1 = 2844초가 되었을 때 초기화
        time3(cnt3);
    }
    function time3(seconds) {
      var min = parseInt((seconds%3600)/60) < 10 ? '0'+ parseInt((seconds%3600)/60) : parseInt((seconds%3600)/60);
      var sec = seconds % 60 < 10 ? '0'+seconds % 60 : seconds % 60;
      document.getElementById("timing3").innerHTML = min+":" + sec;
    }

    // 3
    countUp4();
    up4 = setInterval(countUp4, 1000);
    function countUp4() {
        cnt4++;
        if (cnt4 > 1099) { clearInterval(up4); } // 18:19 을 초로 변환 시 1099
        if (cnt4 == 1099+1) { cnt4 = 0; setInterval(countUp4, 1000); } // 1099+1 = 1100초가 되었을 때 초기화
        time4(cnt4);
    }
    function time4(seconds) {
      var min = parseInt((seconds%3600)/60) < 10 ? '0'+ parseInt((seconds%3600)/60) : parseInt((seconds%3600)/60);
      var sec = seconds % 60 < 10 ? '0'+seconds % 60 : seconds % 60;
      document.getElementById("timing4").innerHTML = min+":" + sec;
    }

    // 4
    countUp5();
    up5 = setInterval(countUp5, 1000);
    function countUp5() {
        cnt5++;
        if (cnt5 > 1380) { clearInterval(up5); } // 23:00 을 초로 변환 시 1380
        if (cnt5 == 1380+1) { cnt5 = 0; setInterval(countUp5, 1000); } // 1380+1 = 1381초가 되었을 때 초기화
        time5(cnt5);
    }
    function time5(seconds) {
      var min = parseInt((seconds%3600)/60) < 10 ? '0'+ parseInt((seconds%3600)/60) : parseInt((seconds%3600)/60);
      var sec = seconds % 60 < 10 ? '0'+seconds % 60 : seconds % 60;
      document.getElementById("timing5").innerHTML = min+":" + sec;
    }

    // 5
    countUp6();
    up6 = setInterval(countUp6, 1000);
    function countUp6() {
        cnt6++;
        if (cnt6 > 1440) { clearInterval(up6); } // 24:00 을 초로 변환 시 1440
        if (cnt6 == 1440+1) { cnt6 = 0; setInterval(countUp6, 1000); } // 1440+1 = 1441초가 되었을 때 초기화
        time6(cnt6);
    }
    function time6(seconds) {
      var min = parseInt((seconds%3600)/60) < 10 ? '0'+ parseInt((seconds%3600)/60) : parseInt((seconds%3600)/60);
      var sec = seconds % 60 < 10 ? '0'+seconds % 60 : seconds % 60;
      document.getElementById("timing6").innerHTML = min+":" + sec;
    }

    // 6
    countUp7();
    up7 = setInterval(countUp7, 1000);
    function countUp7() {
        cnt7++;
        if (cnt7 > 960) { clearInterval(up7); } // 16:00 을 초로 변환 시 960
        if (cnt7 == 960+1) { cnt7 = 0; setInterval(countUp7, 1000); } // 960+1 = 961초가 되었을 때 초기화
        time7(cnt7);
    }
    function time7(seconds) {
      var min = parseInt((seconds%3600)/60) < 10 ? '0'+ parseInt((seconds%3600)/60) : parseInt((seconds%3600)/60);
      var sec = seconds % 60 < 10 ? '0'+seconds % 60 : seconds % 60;
      document.getElementById("timing7").innerHTML = min+":" + sec;
    }

    // 7
    countUp8();
    up8 = setInterval(countUp8, 1000);
    function countUp8() {
        cnt8++;
        if (cnt8 > 600) { clearInterval(up8); } // 10:00 을 초로 변환 시 600
        if (cnt8 == 600+1) { cnt8 = 0; setInterval(countUp8, 1000); } // 600+1 = 601초가 되었을 때 초기화
        time8(cnt8);
    }
